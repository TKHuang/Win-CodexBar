...
pub struct Settings {
    ...
    /// Tighten menu card padding, spacing and type so the flyout fits more
    /// on screen. Purely visual density — no rows are hidden.
    #[serde(default)]
    pub compact_menu_layout: bool,
